		...
		<!-- Formulaire d'inscription -->
			<div class="formulaire">
				<form  action="/PowerRenters/controllers/adminControllerPersonne.php" method="GET" >
					...
					<legend class= "contenuCenter">Modification d'un client</legend>
					...
					<label class="contenuformbis" >Vous êtes :</label>
						...
						<?php
							$tabStatutP = array(1 => 'Particulier', 'Professionnel','Client inactif');
							$script = '';
							if ($afficheUnClient[0]->getStatutPersonne()->getCli_stat_libelle()=="Professionnel")
								{$statutP=2;}
							else if ($afficheUnClient[0]->getStatutPersonne()->getCli_stat_libelle()=="Particulier"){
								{$statutP=1;}
							}
							else $statutP=3;
